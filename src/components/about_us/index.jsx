				...
				<Fade>
					<div className='Card'>
						...
						<p className='info'>
							...
							confeccion, tienen un costo de realizacion, dentro
							de la zona de cobertura (CABA/AMBA) deducibles al
							momento de contratacion. los presupuestos via correo
							electronico son SIN CARGO! Realizamos el
							mantenimiento necesario de los sistemas que
							comercializamos mediante un abono anual o
							simplemente a requerimiento de los clientes al
					...
					<div className='Card'>
						...
						<p className='info'>
							...
							todas las herramientas necesarias para realizar el
							mismo. Ademas nuestro equipo cuenta con los
							conocimientos para configurar y poner en
							funcionamiento cualquiera de los sistemas que
							comercializamos aconsejandolos de la mejor manera de
							acuerdo a sus necesidades, siempre contando con
							nuestra garantia de satisfaccion.
						</p>
					</div>
				</Fade>
				<Fade>
					<div className='Card'>
						...
						<p className='info'>
							...
							software de todos los equipos en nuestro catalogo.
						</p>
					</div>
					<div className='Card'>
						<div className='titleContainer'>
						...
						<StyledSVG src={gears} />
						<p className='info'>
							Ofrecemos asesoramiento y soporte de los sistemas de
							seguridad electronica via correo electronico o
							telefonicamente, previa comunicacion con nuestros
							agentes. De acuerdo al tipo de asesoramiento/soporte
							que se escoja, difieren los cargos. Favor consultar!
						</p>
					</div>
				</Fade>
			</div>
